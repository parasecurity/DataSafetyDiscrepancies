...
from utils.command_exec import frun_command
...
class TraversingMode:
    def __init__(self, apk_path, max_retries,):
        ...
        log_file = current_dir/"logs/traversing.log"
        ...
        self.unsuccessful_log = current_dir/"logs/unsuccessful_traversals.log"
        ...
        self.status_file = current_dir/"traversal_status.json"
    ...
    def run_frida_script(self, app, serialnum):
        ...
        frida_cmd = [
            ...
            "-t","300",
            "-w","0",
            "-fl","frida-scripts/sslunpinning.js", "frida-scripts/functionharvester.js"
            # "-fl","frida-scripts/functionharvester.js"
        ]
        ...
        while True:
            ...
            if output:  # If there is output, print it
                print(output.strip())  # Print each line of output as it is generated
